...
public class exercicio12 {
    ...
    private static final String MATRICULA = "888999";
    ...
    /* ---------- Arvore Binaria de Busca (chave: nome) ---------- */
    ...
    public static void main(String[] args) throws IOException {
        ...
        PrintWriter pw = new PrintWriter(new FileWriter(MATRICULA + "_arvore_binaria.txt"));
